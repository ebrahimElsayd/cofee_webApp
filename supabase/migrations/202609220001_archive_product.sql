create or replace function public.manager_archive_product(
  p_product_id uuid
)
returns void
language plpgsql
...
revoke all on function public.manager_archive_product(uuid) from public;
grant execute on function public.manager_archive_product(uuid) to authenticated, service_role;
